...
<head>
    ...
    <!-- ExtJS -->
	<script type="text/javascript" src="<?= base_url('assets/ext/ext-all-4.2.2.js') ?>"></script>
	<link rel="stylesheet" type="text/css" href="<?= base_url('assets/ext/resources/css/ext-all.css') ?>" />
	<!--
    <script type="text/javascript" src="http://docs.sencha.com/extjs/4.2.2/extjs-build/examples/shared/include-ext.js"></script>
    <script type="text/javascript" src="http://docs.sencha.com/extjs/4.2.2/extjs-build/examples/shared/options-toolbar.js"></script>
   -->

    <!-- Shared -->
    <link rel="stylesheet" type="text/css" href="http://docs.sencha.com/extjs/4.2.2/extjs-build/examples/shared/example.css" />

    <!-- Example -->
    <link rel="stylesheet" type="text/css" href="http://docs.sencha.com/extjs/4.2.2/extjs-build/examples/ux/grid/css/GridFilters.css" />
    <link rel="stylesheet" type="text/css" href="http://docs.sencha.com/extjs/4.2.2/extjs-build/examples/ux/grid/css/RangeMenu.css" />
