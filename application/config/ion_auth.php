...
$config['tables']['groups']          = 'tbl_group';
$config['tables']['users_groups']    = 'tbl_user_group';
$config['tables']['login_attempts']  = 'tbl_login_attempt';
 ...
 */
$config['site_title']                 = "twilles.com";       // Site Title, example.com
$config['admin_email']                = "admin@twilles.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['identity']                   = 'username';//'email';             // A database column which is used to login with
