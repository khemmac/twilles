Ext.define('TCMS.StyleGroup.Main', {
	...
	initComponent : function() {
		...
		var window = Ext.create('TCMS.StyleGroup.Window');

		var grid = Ext.create('TCMS.StyleGroup.Grid', {
			region: 'center',
			border: false,
		...
		addAct.setHandler(function(){
			window.openDialog('Add base style group', 'add', grid, {
				type: 'style_group'
			});
		});

		editAct.setHandler(function(){
			window.openDialog('Edit base style group', 'edit', grid, {
