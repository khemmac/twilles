Ext.define('TCMS.Inventory.Main', {
	...
	initComponent : function() {
		...
		var window = Ext.create('TCMS.Inventory.Window');

		var grid = Ext.create('TCMS.Inventory.Grid', {
			region: 'center',
			border: false,
		...
		addAct.setHandler(function(){
			window.openDialog('Add inventory', 'add', grid, {
				type: 'inventory'
			});
		});

		editAct.setHandler(function(){
			window.openDialog('Edit inventory', 'edit', grid, {
