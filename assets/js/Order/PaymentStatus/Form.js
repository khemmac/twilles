Ext.define('TCMS.Order.PaymentStatus.Form', {
	extend	: 'BASE.Form',
	requires : ['BASE.Form'],
	constructor:function(config) {
		...
		this.changeStatusPending = function(id){
			changeStatus(__site_url+'backend/order/PaymentStatusPending', {
				id: id
			});
		};
		this.changeStatusPaid = function(id){
			changeStatus(__site_url+'backend/order/PaymentStatusPaid', {
				id: id
			});
		};
